...
+ “supply” - это сущность, которая несет в себе информацию о поставках товаров в магазин, через ключ "supply of good", которая несет детальную информацию о количестве и стоимости поставленного товара 
...
+ для метода оплаты оффлайн или онлайн заказа (у каждого заказа только один метод оплаты, но методы заказа повторяются).
+ для типа доставки и онлайн заказа
